...
export class GolfGame{
 ...
 preview(){let ball=this.launch(),path=[{...ball}],result='moving';for(let i=0;i<1500;i++){result=integrate(ball,STEP,this.hole,this.wind);if(i%8===0)path.push({...ball});if(result!=='moving')break;}path.push({...ball});return{path,end:ball,result};}
